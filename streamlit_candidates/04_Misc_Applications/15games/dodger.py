...
def main():
    ...
    try:
        ...
        st.write("Warning: Could not load sound files from assets/")
        gameOverSound = None
    ...
    try:
        ...
        st.write("Error: Could not load image files from assets/. Make sure player.png and baddie.png exist.")
        sys.exit()
