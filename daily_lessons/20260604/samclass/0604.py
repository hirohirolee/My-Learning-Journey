...
"""
"""
k = int(input("請輸入體重(公斤):"))
g = int(input("請輸入身高(公分):")) 
BMI = k / (g * g)

print (f"BMI={k:4.1f} / ({g:3.2f} x {g:3.2f}) = {BMI:6.2f}")
...
g = float(input("請輸入身高(公分):")) / 100  # 直接轉為公尺
ged = input("請輸入性別(M:男性/F:女性): ")
BMI = k / (g * g)
...
print("--------     ---------    ----------")
print(f"{min:<8d}     {calc_fee:<9d}    {pay_fee:<10d}")

"""
"""
tot_min = int(input("請輸入停車總分鐘數(分鐘): "))
tot_amt = pay_amt = 0
...
print("停車時間       計算金額     應付金額")
print("--------     ---------    ----------")
print(f"{tot_min:8d}     {tot_amt:9d}    {pay_amt:10d}")

"""
"""
min_val = int(input("請輸入停車時間(分鐘): "))
...
# 4. 輸出結果
print(f"停車時間: {min_val} 分鐘")
print(f"實際計算時間: {actual_min} 分鐘")
print("----------------------------")
print("停車時間     計算金額    應付金額")
print(f"{min_val:<8d}     {calc_fee:<9d}    {pay_fee:<10d}")"""
...
if w1 > 0:
    print(f"{'0~120':<10}   {w1:<4.0f}  {r1:<4.2f}  {fee1:<9.3f}")
if w2 > 0:
    print(f"{'121~330':<10}   {w2:<4.0f}  {r2:<4.2f}  {fee2:<9.3f}")
if w3 > 0:
    print(f"{'331~500':<10}   {w3:<4.0f}  {r3:<4.2f}  {fee3:<9.3f}")
if w4 > 0:
    print(f"{'501~700':<10}   {w4:<4.0f}  {r4:<4.2f}  {fee4:<9.3f}")
if w5 > 0:
    print(f"{'701~1000':<10}   {w5:<4.0f}  {r5:<4.2f}  {fee5:<9.3f}")
if w6 > 0:
    print(f"{'1001~':<10}   {w6:<4.0f}  {r6:<4.2f}  {fee6:<9.3f}")
