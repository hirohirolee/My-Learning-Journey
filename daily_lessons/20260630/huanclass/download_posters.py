...
def download_posters():
    ...
    print(f"Found {len(movies)} movies. Downloading to folder '{output_dir}'...\n")
    ...
    for idx, movie in enumerate(movies, 1):
        ...
        print(f"Downloading [{idx}/{len(movies)}]: {title}")
        print(f"  URL: {img_url}")
    ...
    print("Finished downloading all available posters.")
