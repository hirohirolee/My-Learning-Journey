...
''')
    ...
    while True: # 主遊戲迴圈
        ...
        if getHandValue(playerHand) <= 21:
            ...
            if dealerValue > 21:
                print(f'莊家爆牌了！你贏了 {bet} 元！')
                money += bet
            elif playerValue > dealerValue:
                print(f'你贏了 {bet} 元！')
                money += bet
            elif playerValue < dealerValue:
                print('莊家輸了，莊家點數較大！') # typo correction
                print('莊家贏了！')
                money -= bet
            else:
                print('平手，退回賭注。')
...
def getBet(maxBet):
    """詢問玩家下注金額。"""
    while True:
        print(f'你想下注多少？ (1-{maxBet}，或輸入 QUIT 離開)')
...
def displayHands(playerHand, dealerHand, showDealerHand):
    ...
    print()
    if showDealerHand:
        print('莊家的牌:', getHandValue(dealerHand))
